...
def testElevator():
    events = [
        Event(STOP_PRESSED, 2, queuedAt=1681680657.895128, serial=0),
    ]
    e = runElevator(events, floors=5, openDoorDelay=5.0, interFloorDelay=2.0)
    state = e.state
    stats = e.stats
    ...
    assert stopButtonClearCounts[0] == 0
